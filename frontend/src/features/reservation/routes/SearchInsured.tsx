...
import { SearchInsuredForm } from 'features/reservation/components/searchInsured/SearchInsuredForm';
import { SearchInsuredResult } from '../components/searchInsured/SearchInsuredResult';
